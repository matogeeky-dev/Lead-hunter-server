...
async function deepScroll(page, cellCap, job) {
  try {
    ...
    // The selector never showed up — could be a real "no results" zone, or
    // Google serving a consent/CAPTCHA/error page instead of the map. Only
    // way to tell the difference is to look at what's actually on the page.
